    ...
    return (
            <div className={`item ${item}`}>
                <div className={`product-thumb ${col}`}>
                    ...
                    <img data-name="product_image" src={product.images[0].url} alt={product.name} title={product.name} className="img-responsive" /> 
                    {
                        
                        Object.keys(product.images).length > 1 ? <img  src={product.images[1].url } alt={product.name} title={product.name}  className="img-responsive" /> : <img  src={product.images[0].url } alt={product.name} title={product.name}  className="img-responsive" /> 
                    ...
                    <div className="caption product-detail text-left">
                        ...
                        <span className="price"><span className="amount"><span className="currencySymbol">$</span>{product.price}</span>
                        </span>
