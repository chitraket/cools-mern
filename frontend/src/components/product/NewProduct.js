...
function NewProduct({ title, sort, order, rt1, rta1, i18n, t }) {
    ...
    responsive: [
      {
        breakpoint: 1024,
        settings: {
          slidesToShow: Object.keys(topproduct).length > 3 ? 3 : Object.keys(topproduct).length,
          slidesToScroll: 3,
          infinite: true,
          dots: false
        }
      ...
      },
      {
        breakpoint: 600,
        settings: {
          slidesToShow: Object.keys(topproduct).length > 2 ? 2 : Object.keys(topproduct).length,
          slidesToScroll: 2,
          initialSlide: 2
        }
      },
      {
        breakpoint: 480,
        settings: {
          slidesToShow: Object.keys(topproduct).length > 1 ? 1 : Object.keys(topproduct).length,
          slidesToScroll: 1
        }
      }
    ]
