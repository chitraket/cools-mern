...
export const UPDATE_PRODUCT_STATUS_RESET = 'UPDATE_PRODUCT_STATUS_RESET'

export const ALL_TOP_PRODUCTS_REQUEST = 'ALL_TOP_PRODUCTS_REQUEST'
export const ALL_TOP_PRODUCTS_SUCCESS = 'ALL_TOP_PORDUCTS_SUCCESS'
export const ALL_TOP_PRODUCTS_FAIL = 'ALL_TOP_PORDUCTS_FAIL'

export const ALL_BEST_PRODUCTS_REQUEST = 'ALL_BEST_PRODUCTS_REQUEST'
export const ALL_BEST_PRODUCTS_SUCCESS = 'ALL_BEST_PORDUCTS_SUCCESS'
export const ALL_BEST_PRODUCTS_FAIL = 'ALL_BEST_PORDUCTS_FAIL'

export const ALL_PRODUCTS_CATEGORY_REQUEST = 'ALL_PRODUCTS_CATEGORY_REQUEST'
export const ALL_PRODUCTS_CATEGORY_SUCCESS = 'ALL_PRODUCTS_CATEGORY_SUCCESS'
export const ALL_PRODUCTS_CATEGORY_FAIL = 'ALL_PRODUCTS_CATEGORY_FAIL'

export const ALL_PRODUCTS_BRAND_REQUEST = 'ALL_PRODUCTS_BRAND_REQUEST'
export const ALL_PRODUCTS_BRAND_SUCCESS = 'ALL_PRODUCTS_BRAND_SUCCESS'
