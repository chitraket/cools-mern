...
import { productsReducer, productDetailsReducer, topProductReducer, newReviewReducer, newProductReducer, productReducer, productReviewReducer, reviewReducer, categoryProductReducer, brandProductReducer, bestProductReducer, newColorReducer, getColorReducer, colorReducer, colorDetailsReducer } from './reducers/productReducers'
import { authReducer, userReducer, forgotPasswordReducer, allUsersReducer, userDetailsReducer, favoriteReducer, favoriteDetailsReducer, allAdminReducer, AddAdminReducer } from './reducers/userReducers'
import { cartReducer } from './reducers/cartReducers';
import { allDateOrdersReducer, allOrdersReducer, allTotalOrdersReducer, myOrdersReducer, newOrderReducer, orderDetailsReducer, orderReducer } from './reducers/orderReducers';
...
const reducer = combineReducers({
    ...
    order: orderReducer,
    dateorder: allDateOrdersReducer,
